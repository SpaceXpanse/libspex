...
#ifndef JSONRPC_CPP_STUB_XAYAWALLETRPCCLIENT_H_
#define JSONRPC_CPP_STUB_XAYAWALLETRPCCLIENT_H_

#include <jsonrpccpp/client.h>

class XayaWalletRpcClient : public jsonrpc::Client
{
    public:
        XayaWalletRpcClient(jsonrpc::IClientConnector &conn, jsonrpc::clientVersion_t type = jsonrpc::JSONRPC_CLIENT_V2) : jsonrpc::Client(conn, type) {}
...
#endif //JSONRPC_CPP_STUB_XAYAWALLETRPCCLIENT_H_
