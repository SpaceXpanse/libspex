...
class Daemon ():
  ...
  This class is used for the SpaceXpanseships and game-channel integration tests,
  ...
  * provide the "stop" and "getcurrentstate" RPC methods.
  ...
  def __init__ (self, playerName, basedir, port, binary):
    self.log = logging.getLogger ("sidechannel.channeltest.Daemon")
...
class TestCase (SpaceXpanseGameTest):
  """
