...
#ifndef SPACEXPANSEGAME_HEIGHTCACHE_HPP
#define SPACEXPANSEGAME_HEIGHTCACHE_HPP
 ...
 * a block hash (e.g. by calling SpaceXpanse Core's RPC interface).  That is used
...
#endif // SPACEXPANSEGAME_HEIGHTCACHE_HPP
