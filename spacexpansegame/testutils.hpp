...
#ifndef SPACEXPANSEGAME_TESTUTILS_HPP
#define SPACEXPANSEGAME_TESTUTILS_HPP

/* Shared utility functions for unit tests of spacexpansegame.  */
...
#include "rpc-stubs/spacexpansewalletrpcclient.h"
#include "rpc-stubs/spacexpansewalletrpcserverstub.h"
...
/**
 * Mock server for SpaceXpanse Core's JSON-RPC interface.
 */
class MockSpaceXpanseRpcServer : public SpaceXpanseRpcServerStub
{
...
public:
  ...
  using RpcClient = SpaceXpanseRpcClient;
   ...
   */
  explicit MockSpaceXpanseRpcServer (jsonrpc::AbstractServerConnector& conn);

  MockSpaceXpanseRpcServer () = delete;
  MockSpaceXpanseRpcServer (const MockSpaceXpanseRpcServer&) = delete;
  void operator= (const MockSpaceXpanseRpcServer&) = delete;
...
/**
 * Mock server for SpaceXpanse Core's wallet JSON-RPC interface.
 */
class MockSpaceXpanseWalletRpcServer : public SpaceXpanseWalletRpcServerStub
{
...
public:
  ...
  /** The type of the corresponding RPC client.  */
  using RpcClient = SpaceXpanseWalletRpcClient;
   ...
   * tests can explicitly specify the calls they want.
   */
  explicit MockSpaceXpanseWalletRpcServer (jsonrpc::AbstractServerConnector& conn);

  MockSpaceXpanseWalletRpcServer () = delete;
  MockSpaceXpanseWalletRpcServer (const MockSpaceXpanseWalletRpcServer&) = delete;
  void operator= (const MockSpaceXpanseWalletRpcServer&) = delete;
...
#endif // SPACEXPANSEGAME_TESTUTILS_HPP
