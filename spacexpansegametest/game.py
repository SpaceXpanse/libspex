...
class Node ():
  ...
  * provide at least the "stop" and "getcurrentstate" RPC methods.
  ...
  def __init__ (self, basedir, port, binary):
    ...
    self.log = logging.getLogger ("spacexpansegametest.gamenode")
  ...
  def start (self, spacexpanserpc, extraArgs=[], wait=True):
    ...
    args.append ("--spacexpanse_rpc_url=%s" % spacexpanserpc)
